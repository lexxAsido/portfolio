...
const experiencesData = [
  ...
  },
  {
    ...
    icon: React.createElement(MdPhoneIphone),
    date: "April 2025 - May 2025 | Remote",
  },
  {
  title: "Mobile Developer – NOLT Finance",
  location: "Lagos, Nigeria",
  description: "Developing and maintaining the NOLT Finance mobile app using React Native. Integrated key features such as wallet transactions, wallet-to-wallet transfers, wallet-to-bank transfers, wallet funding,Loan modules, bill payments and investment modules. I also integrated Dojah for face verification and Paystack for easy funding. The app is currently live on the Play Store and App store, with ongoing development focused on delivering new financial tools and enhancements.",
  icon: React.createElement(MdPhoneIphone),
...
const projectsData = [
  ...
  title: 'Nolt Finance',
  description:
    "Nolt Finance is a cross-platform fintech mobile application built with React Native, designed to make digital banking and financial services accessible in Nigeria. The app enables users to apply for and manage loans, fund wallets via Paystack, transfer money from wallet to bank, invest, and pay bills. It also integrates Doja for biometric verification, ensuring secure onboarding and compliance, while providing a clean and responsive user experience across iOS and Android.",
  tech: 'React-Native | Expo | RESTful API | TypeScript | Redux Toolkit | Axios | Paystack | Doja',
  liveDemo: 'https://play.google.com/store/apps/details?id=com.nolt.app',
...
},
{
    ...
    tech: 'React-Native | Livescores-Api-Integration | Firebase Db | Admob',
    liveDemo: 'https://apps.apple.com/ng/app/tipngoal/id6756491076',
  ...
  {
  img: '/kreados.jpg',
  title: 'Kreados - Online Shopping Mall',
  description:
    "Kreados is a cross-platform eCommerce mobile application built with React Native. It provides users with a seamless online shopping experience, featuring product listings, detailed product pages, cart management, secure checkout, and order tracking. The app integrates a 3-step shipping and payment workflow, personalized user profiles, and a modern UI/UX powered by Tailwind (NativeWind).",
  tech: 'React Native | Expo | Redux | Tailwind (NativeWind) | TypeScript | Firebase | DotEnv ',
  liveDemo: '',
  github: 'https://github.com/lexxAsido',
},
