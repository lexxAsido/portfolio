...
const projectsData = [
  {
    title: "Asidrop",
    description:
      "Asidrop is a dynamic delivery platform designed for seamless logistics across Nigeria. With an intuitive user interface, it enables users to effortlessly input details of their goods or products, including pickup and delivery locations, package size, and type.",
  ...
  },
  {
    ...
    description:
      "Shop smarter with SkyCart is an application designed to redefine online shopping experience and bringing a world of products to your fingertips with fast delivery, exclusive deals, and hassle-free checkout. Click Visit Link to download App andriod Apk",
    ...
    imageUrl: "/Sky.jpg",
    siteUrl:"skycart-app.apk"
  },
  {
    title: "Lexx Media Mobile-App",
    description:
      "Lexx Media is your all-in-one app with an intuitive interface delivers breaking news, trending music tracks, and upcoming Nigerian events both local and International tailored to your interests. Click Visit Link to download App andriod Apk",
