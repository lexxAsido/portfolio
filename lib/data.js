...
const experiencesData = [
  ...
  location: "Lagos, Nigeria",
  description: "Developing and maintaining the NOLT Finance mobile app using React Native. Integrated key features such as wallet transactions, wallet-to-wallet transfers, wallet-to-bank transfers, wallet funding, and investment modules. The app is currently live on the Play Store, with ongoing development focused on delivering new financial tools and enhancements.",
  icon: React.createElement(MdPhoneIphone),
